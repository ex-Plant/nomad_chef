      ...
      <div className="px-6 md:px-12 lg:px-20 z-2 relative">
        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-12 md:gap-8">
          ...
          <div className="flex flex-col justify-center md:col-span-5 md:col-start-1">
            <FadeUp as="h2" delay={0.1} className="font-[family-name:var(--font-archivo-black)] text-5xl uppercase leading-[0.85] tracking-tighter text-electric-blue md:text-7xl lg:text-8xl">
              Camp
              <br />
              Food
            </FadeUp>
